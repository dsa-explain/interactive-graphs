...
Type a traversal in the editor, then press **Play** to watch it run, or **Step** to advance one line. The graph highlights rooms in `danger_rooms` in orange as each line of your code runs.

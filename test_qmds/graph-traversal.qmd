...
Before we do that, lets have a short list of definitions.
...
Note: Use the variable `danger_rooms` to track the rooms that are dangerous. This list will be visualised.

Type a traversal in the editor, then press **Play**. The graph highlights rooms in `danger_rooms` in orange as each line of your code runs.
